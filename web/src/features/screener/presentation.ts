...
export function metricHelp(metric: MetricSpec): string {
  ...
  if (metric.key === "ma250_reclaim_3d_shadow_recent5_2y") return "以下任一满足即可，完成日必须在市场最近5个已入库交易日内：①前一根收盘>当天MA250，当根收盘<当天MA250，随后第1～3根收盘重新>各自当天MA250，仅记录首次收复。②单K或双K合并后形成下影支撑：最低价距其当天MA250在±2%以内，下影>0且≥实体，最终收盘>当天MA250。双K使用首根开盘、末根收盘和两根最低价合成。不要求此前两次有效支撑；不限制成交量。扫描近两年背景，图上标记最近5日命中的实际区间和形态类别。";
