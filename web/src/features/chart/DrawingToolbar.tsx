import { Ban, CircleDotDashed, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="drawing-toolbar">
      ...
      <div className="geometry-kinds">
        <button type="button" aria-label="水平区间" className={geometry === "horizontal" ? "active" : ""} onClick={() => onGeometryChange("horizontal")}><CircleDotDashed size={14} />水平区间</button>
        <button type="button" aria-label="趋势区间" className={geometry === "trend" ? "active" : ""} onClick={() => onGeometryChange("trend")}><TrendingUp size={14} />趋势区间</button>
      </div>
